...
Lakes380.ss.rarefied <- readRDS("Lakes380.ss.rarefied.rds") 


shared_samples <- intersect(sample_names(Lakes380.ss.rarefied), sample_names(ps.merged))

# Filter both objects to only include those samples
ps.taxonomy_common <- prune_samples(shared_samples, Lakes380.ss.rarefied)
